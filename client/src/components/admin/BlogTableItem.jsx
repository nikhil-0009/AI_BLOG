...
const BlogTableItem = ({blog, fetchBlogs,index}) => {
  ...
  return (
    <tr className='border-y border-gray-300'>
        ...
        <td className='px-2 py-4 flex text-xs justify-around'>
            <button onClick={togglePublish} className='border px-2 py-0.5 mt-1 rounded cursor-pointer'>{blog.isPublished ?'UnPublish':'Publish Again'}</button>
