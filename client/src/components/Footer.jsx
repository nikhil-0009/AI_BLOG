      ...
      <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500 text-gray-500">
        <div>
          ...
          <p className="max-w-[410px] mt-6">
            QuickBlog is a modern, user-friendly blogging platform that lets you
            create, search, and share blogs effortlessly. With features like
            real-time search, AI integration, and a clean interface, it offers a
            seamless writing and reading experience.
          </p>
        </div>
        <div className="flex flex-wrap justify-baseline w-full md:w-[45%] gap-5">
